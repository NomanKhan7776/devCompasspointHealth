    ...
    const countdownInterval = setInterval(() => {
      setCountdown(prev => {
        if (prev <= 1) {
          ...
          // Build backend URL
          const backendUrl = `${import.meta.env.VITE_REACT_API_URL}/patients/verify/${id}?s=${signature}`;
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Invalid SmartToken</h1>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-4">SmartToken Detected</h1>
          <p className="text-gray-600 mb-6">Verifying your emergency access token...</p>
